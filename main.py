...
if __name__ =="__main__":
    ...
    print(audio_path,new_audio_path, start_minutes, start_seconds, end_minutes, end_seconds)
    start_milliseconds, end_milliseconds = convert_to_milliseconds(start_minutes, start_seconds, end_minutes, end_seconds)
